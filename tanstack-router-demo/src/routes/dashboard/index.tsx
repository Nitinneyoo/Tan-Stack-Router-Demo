    ...
    <header className="bg-primary text-white py-16">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-lg md:text-xl mb-6">
          Explore four cutting-edge robots designed for diverse applications
        </p>
        <Button
          onClick={() => window.alert("Discover robots clicked!")}
  ...
  const robots: RobotDetail[] = [
    {
      title: "X-1 Scout",
      description:
        "A compact reconnaissance robot for surveillance and data collection in challenging environments.",
      specs: [
    ...
    },
    {
      title: "X-2 Worker",
      description:
        "A robust industrial robot for heavy-duty tasks in manufacturing and logistics.",
      specs: [
    ...
    },
    {
      title: "X-3 Medic",
      description:
        "A medical assistant robot for hospitals, designed for patient care and support.",
      specs: [
    ...
    },
    {
      title: "X-4 Explorer",
      description:
        "An autonomous exploration robot for extreme environments like space or deep sea.",
      specs: [
    ...
    <section className="py-16 bg-primary text-white">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-lg mb-6">
          Contact us to find the perfect robot for your needs.
        </p>
