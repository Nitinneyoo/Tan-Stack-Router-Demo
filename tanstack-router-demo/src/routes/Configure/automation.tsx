...
const automationSchema = z.object({
  workflowMode: z.enum(
    ["Fully Automated", "Semi-Automated", "Operator-Assisted"],
    {
  ...
  errorHandlingMode: z.enum(
    ["Auto-Recover", "Pause and Alert", "Manual Intervention"],
    {
      errorMap: () => ({ message: "Select an error handling mode" }),
    }
  ),
  powerOptimization: z.enum(
    ["Max Efficiency", "Balanced", "High Performance"],
    {
  ...
  movementPrecision: z
    .number()
    .min(0.1, "Precision must be at least 0.1 mm")
    .max(5, "Precision cannot exceed 5 mm"),
  ...
  component: () => {
    ...
    const handleSave = () => {
      try {
        ...
        setMessage({
          type: "success",
          text: "Settings validated successfully!",
        });
        setErrors({});
      } catch (error) {
            ...
            <div className="max-w-2xl mx-auto flex flex-col gap-6">
              ...
              {activeSetting === "powerOptimization" && (
                <div className="bg-background p-6 border border-gray-300 rounded-lg">
                  ...
                  <div className="flex gap-2">
                    {["Max Efficiency", "Balanced", "High Performance"].map(
                      (mode) => (
                        <Button
                          key={mode}
                          variant={
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      ...
                      onClick={() =>
                        handleChange(
                          "movementPrecision",
                          Math.max(0.1, configData.movementPrecision - 0.1)
                        )
                      }
                    >
                      -
                    ...
                    <Button
                      ...
                      onClick={() =>
                        handleChange(
                          "movementPrecision",
                          Math.min(5, configData.movementPrecision + 0.1)
                        )
                      }
                    >
                      +
              ...
              <div className="bg-background p-6 border border-gray-300 rounded-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-black">
                  ...
                  <p>
                    Movement Precision:{" "}
                    {configData.movementPrecision.toFixed(1)} mm
                  </p>
